                    ...
                    <nav className="navbar navbar-expand-md navbar-light">
                        ...
                        <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul className="navbar-nav ">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" href="/servicios">Our Services</Link>
                            ...
                            <div className="others-options d-flex align-items-center ms-auto">
                                ...
                                <div className="option-item">
                                    <a className="opt" href="#ortencySlideCartCanvas"  data-bs-toggle="offcanvas" data-bs-target="#ortencySlideCartCanvas" aria-controls="ortencySlideCartCanvas"><i className='bx bx-shopping-bag' ></i><span className="badge">3</span></a>
                                </div>
                                <div className="option-item d-none d-xl-inline-block">
                                    <Link className="nav-link active" href="/quote">Free Quote</Link>
